...
ServerEvents.recipes(event => {
	...
	function addRecipes() {
		...
		event.shaped('2x biggerreactors:reactor_casing', [
			'SLS',
			'LGL',
			'SLS'
		], {
		...
		// Advanced canisters cost yellow canister
		event.replaceInput({id: 'bhc:blue_heart_canister'}, 'bhc:green_heart_canister', 'bhc:yellow_heart_canister')
		event.replaceInput({id: 'bhc:smithing/soul_heart_canister'}, 'bhc:blue_heart_canister', 'bhc:yellow_heart_canister')
	}
